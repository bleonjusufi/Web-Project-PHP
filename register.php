...
class Register {
  ...
  public function validateForm($username, $email, $password, $password2) {
    ...
    if (isset($success_msg)) {
      echo "<script type='text/javascript'>alert('$success_msg'); window.location.href='loginform.php';</script>";
    }

    if (isset($error_msg)) {
      echo "<script type='text/javascript'>alert('$error_msg'); window.location.href='loginform.php';</script>";
    }
  }
}
...
<?php if (isset($success_msg)): ?>
	<script type="text/javascript">window.location.href='loginform.php';
