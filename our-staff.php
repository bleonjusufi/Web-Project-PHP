...
<html lang="en">
  <head>
    ...
    <title>UBT University-Our-Staff</title>
    ...
    <main>
      <div class="row">
        <div class="column">
          <div class="card">
            <img
              src="CSS\Images\Edmond-Hajrizi.jpg"
              alt="Edmond Hajrizi"
              style="width: 100%"
            />
            <div class="container">
              <h2>Dr.Sc.Edmond Hajrizi</h2>
              <p class="title">Rektor</p>
              <p>Founder and President of UBT-University since 2001</p>
              <p>edmond.hajrizi@ubt-uni.net</p>
        ...
        <div class="column">
          <div class="card">
            <img
              src="CSS\Images\Bertan-Karahoda.jpg"
              alt="Bertan Karahoda"
              style="width: 100%"
            />
            <div class="container">
              <h2>Dr.Sc.Bertan Karahoda</h2>
              <p class="title">Profesor</p>
              <p>Lecturer at UBT-University since ...</p>
              <p>bertan.karahoda@ubt-uni.net</p>
              <p><button class="card-button">Contact</button></p>
            </div>
          </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <img
              src="CSS\Images\Blerim-Zylfiu.jpg"
              alt="Blerim Zylfiu"
              style="width: 100%"
            />
            <div class="container">
              <h2>Dr.Sc.Blerim Zylfiu</h2>
              <p class="title">Profesor</p>
              <p>Lecturer at UBT-University since 2018</p>
              <p>blerim.zylfiu@ubt-uni.net</p>
              <p><button class="card-button">Contact</button></p>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
            <img
              src="CSS\Images\Lavdim-Menxhiqi.jpg"
              alt="Lavdim Menxhiqi"
              style="width: 100%"
            />
            <div class="container">
              <h2>Dr.Sc.Lavdim Menxhiqi</h2>
              <p class="title">Profesor</p>
              <p>Lecturer at UBT-University since 2018</p>
              <p>lavdim.menxhiqi@ubt-uni.net</p>
              <p><button class="card-button">Contact</button></p>
            </div>
          </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <img
              src="CSS\Images\Diellza-Berisha.jpg"
              alt="Diellza Berisha"
              style="width: 100%"
            />
            <div class="container">
              <h2>MSc.Diellza Berisha</h2>
              <p class="title">Teaching Assistant</p>
              <p>Teaching Assistant at UBT-University since 2013</p>
              <p>diellza.berisha@ubt-uni.net</p>
              <p><button class="card-button">Contact</button></p>
            </div>
          </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <img
              src="CSS\Images\Medina-Shamolli.jpg"
              alt="Medina Shamolli"
              style="width: 100%"
            />
            <div class="container">
              <h2>MSc.Medina Shamolli</h2>
              <p class="title">Profesoreshe</p>
              <p>Lecturer at UBT-University since 2017</p>
              <p>medina.shamolli@ubt-uni.net</p>
              <p><button class="card-button">Contact</button></p>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="column">
          <div class="card">
            <img
              src="CSS\Images\Ramiz-Hoxha.jpg"
              alt="Ramiz Hoxha"
              style="width: 100%"
            />
            <div class="container">
              <h2>MSc.Ramiz Hoxha</h2>
              <p class="title">Profesor</p>
              <p>Lecturer at UBT-University since 2014</p>
              <p>ramiz.hoxha@ubt-uni.net</p>
              <p><button class="card-button">Contact</button></p>
            </div>
          </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <img
              src="CSS\Images\Vesa-Morina.jpg"
              alt="Vesa Morina"
              style="width: 100%"
            />
            <div class="container">
              <h2>MSc.Vesa Morina</h2>
              <p class="title">Profesoreshe</p>
              <p>Lecturer at UBT-University since 2019</p>
              <p>vesa.morina@ubt-uni.net</p>
              <p><button class="card-button">Contact</button></p>
            </div>
          </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <img
              src="CSS\Images\Blerina-Rrmoku.jpg"
              alt="Blerina Rrmoku"
              style="width: 100%"
            />
            <div class="container">
              <h2>BSc.Blerina Rrmoku</h2>
              <p class="title">Teaching Assistant</p>
              <p>Teaching Assistant at UBT-University since 2021</p>
              <p>blerina.rrmoku@ubt-uni.net</p>
              <p><button class="card-button">Contact</button></p>
            </div>
          </div>
        </div>
